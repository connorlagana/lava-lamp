...
import { ACCENT_LABEL, ACCENT_RGB, ACCENTS, ancestors, type Camera, CONVICTIONS, lavaFor, type Level, pigmentOf, THOUGHT_TYPES } from '@field/core';
...
export function NoteSheet() {
  ...
  return (
    ...
    >
      <article
        className="sheet"
        style={{ ['--accent' as string]: lavaFor(pigmentOf(app.board, node.id), node.depth).rgb }}
      >
        {path.length > 0 && (
              ...
              <div className="swatches">
                {ACCENTS.map((a) => (
                  <button
                    ...
                    data-none={a === 'none' || undefined}
                    style={{ ['--sw' as string]: ACCENT_RGB[a] }}
